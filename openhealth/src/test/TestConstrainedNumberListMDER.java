...
public class TestConstrainedNumberListMDER {
	...
	public static void main(String[] args) {
		...
		NomPartition iu = new NomPartition();
		iu.setValue(new Integer(5));
		
		try {		
			IEncoder<NomPartition> encoder = CoderFactory.getInstance().newEncoder("MDER");
