...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "My_AVA_Type", isSet = false )
    public class My_AVA_Type implements IASN1PreparedElement {
	...
	private ShortDesc desc = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(My_AVA_Type.class);
